...
- Pause requested by user: pause all modernization work until the user resumes (user is going to bed; working on a laptop). No further automated changes will be made. (2026-04-19)
